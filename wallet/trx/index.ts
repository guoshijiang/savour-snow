...
function buildTronTransaction(params: any) {
...
function createTRC20Tx(params: any) {
    ...
    let toAddressHex: string = decode58ToHex(to);
...
function createTRC10Tx(params: any) {
...
function encodeData(to: string, amountBig: BigNumber) {
    const ABI = [
